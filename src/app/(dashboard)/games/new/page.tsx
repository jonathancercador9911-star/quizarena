...
export default async function NewGamePage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <CreateGameWizard banks={banks.map((b) => ({ id: b.id, name: b.name, category: b.category ?? (b.isSystem ? "Sistema" : "Mis bancos"), isSystem: b.isSystem, questionCount: b._count.bankQuestions }))} />
    </div>
  );
}
